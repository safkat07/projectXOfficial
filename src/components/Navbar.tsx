...
export default function Navbar() {
    ...
    return (
        <div>
            ...
            <div className={`lg:hidden   fixed top-0 right-0 h-full w-[70%] bg-blue-500 min-h-dvh transition-transform duration-500 transform ${open ? "translate-x-0" : "translate-x-full"}`}>
